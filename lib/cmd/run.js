          ...
          .spread((options = {}, client) => {
            ...
            client.on('data', (payload) => {
              if (payload.type == 'stdout') {
                term.colorRgb(133,153,0).bold('>')(' ')(payload.text);
                return;
              }

              if (payload.type == 'stderr') {
                term.colorRgb(220,50,47)('>')('\t').red(payload.text);
                return;
              }
            });
                              ...
                              .then((text) => {
                                ...
                                return Promise
                                        ...
                                        .then((result) => {
                                          ...
                                          term.colorRgb(38,139,210)('HTTP').colorRgb(211,54,130)('/').colorRgb(108,113,196)('1.1')(' ').colorRgb(108,113,196)(response.statusCode)(' ').colorRgb(133,153,0)('OK')('\n')
                                          _.each(response.headers, (s, key) => {
                                            term.colorRgb(133,153,0)(key).colorRgb(211,54,130)(':')(' ').colorRgb(215,215,175)(s)('\n');
                                          });
                                          term('\n');
